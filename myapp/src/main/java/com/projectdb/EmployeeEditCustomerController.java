...
public class EmployeeEditCustomerController  {
    ...
    private void SubmitButtonOnACtion(ActionEvent e){
        ...
        try {
            ...
            try {
                App.connectDB.createStatement().executeUpdate( "insert into log values(null,\""+App.email+"\",now(), \"UPDATE\", 0, \"customer\")");
                ...
                App.connectDB.createStatement().executeQuery( "insert into log values(null,\""+App.email+"\",now(), \"UPDATE\", 0, \"city\")");
                App.connectDB.createStatement().executeQuery( "insert into log values(null,\""+App.email+"\",now(), \"UPDATE\", 0, \"country\")");
            } catch (Exception x) {
                x.printStackTrace();
            }
        }
    ...
    private void initializeLeftLabels(){
        ...
        String query = "select * from customer inner join user on user_id=customer_id natural join address natural join city natural join country where customer.customer_id = \"" + String.valueOf(EmployeeController.editID) + "\";";
        ...
        try {
            ...
            if (Data.next()){
                ...
                LeftLabel1.setText( String.valueOf( Data.getInt("customer_id")) );
                ...
                LeftLabel7.setText( String.valueOf( Data.getInt("active")) );
