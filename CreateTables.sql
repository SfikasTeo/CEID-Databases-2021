...
CREATE TABLE IF NOT EXISTS series (
    ...
    CONSTRAINT fk_series_language FOREIGN KEY (language_id) REFERENCES lang (lang_id) ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS season (
    ...
    CONSTRAINT season_to_series FOREIGN KEY (series_id) REFERENCES series(series_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS season_actor(
    ...
    CONSTRAINT fk_series_actor_season FOREIGN KEY (in_season) REFERENCES season(season_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS series_category (
    ...
    CONSTRAINT fk_series_category_category FOREIGN KEY (category_id) REFERENCES category (category_id) ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS customer (
    ...
    CONSTRAINT fk_user_customer FOREIGN KEY (customer_id) REFERENCES user(user_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS employee (
    ...
    CONSTRAINT fk_user_employee FOREIGN KEY (employee_id) REFERENCES user(user_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS admin (
    ...
    CONSTRAINT fk_user_admin FOREIGN KEY (admin_id) REFERENCES user(user_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS rental (
    ...
    CONSTRAINT fk_rental_film_film FOREIGN KEY (film_id) REFERENCES film (film_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_rental_episode_ep FOREIGN KEY (episode_id) REFERENCES episode (episode_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS log (
    ...
    CONSTRAINT fk_log_user FOREIGN KEY (email) REFERENCES user (email) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;